package com.douglei.core.dialect.impl.mysql.datatype.handler.dbtype;
...
import com.douglei.core.dialect.impl.mysql.datatype.handler.classtype.BlobDataTypeHandler;
...
public class BlobDBDataTypeHandler extends DBDataTypeHandler{
	...
	public String getTypeName() {
		return com.douglei.core.dialect.impl.mysql.datatype.Mediumblob.singleInstance().getTypeName();
	}

	@Override
	public int getSqlType() {
		return com.douglei.core.dialect.impl.mysql.datatype.Mediumblob.singleInstance().getSqlType();
	}
