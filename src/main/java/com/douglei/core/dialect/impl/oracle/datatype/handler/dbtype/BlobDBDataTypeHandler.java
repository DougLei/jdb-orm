package com.douglei.core.dialect.impl.oracle.datatype.handler.dbtype;
...
import com.douglei.core.dialect.impl.oracle.datatype.handler.classtype.BlobDataTypeHandler;
...
public class BlobDBDataTypeHandler extends DBDataTypeHandler{
	...
	public String getTypeName() {
		return com.douglei.core.dialect.impl.oracle.datatype.Blob.singleInstance().getTypeName();
	}
	
	@Override
	public int getSqlType() {
		return com.douglei.core.dialect.impl.oracle.datatype.Blob.singleInstance().getSqlType();
	}
