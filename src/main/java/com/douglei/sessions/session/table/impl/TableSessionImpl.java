...
import com.douglei.sessions.session.table.impl.persistent.ExecutionHolder;
import com.douglei.sessions.session.table.impl.persistent.ExecutionType;
import com.douglei.sessions.session.table.impl.persistent.Identity;
import com.douglei.sessions.session.table.impl.persistent.PersistentObject;
import com.douglei.sessions.session.table.impl.persistent.RepeatPersistentObjectException;
import com.douglei.sessions.session.table.impl.persistent.State;
