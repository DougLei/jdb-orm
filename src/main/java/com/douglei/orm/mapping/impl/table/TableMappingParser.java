...
import com.douglei.orm.mapping.context.parser.MappingImportDataContext;
...
class TableMappingParser {
	private static final TableMetadataParser tableMetadataParser = new TableMetadataParser();
	private static final ColumnMetadataParser columnMetadataParser = new ColumnMetadataParser();
	...
	public TableMapping parse(InputStream input) throws Exception {
		...
		return new TableMapping(tableMetadata);
	}
