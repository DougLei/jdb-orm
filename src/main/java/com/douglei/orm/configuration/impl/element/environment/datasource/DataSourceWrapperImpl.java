package com.douglei.orm.configuration.impl.element.environment.datasource;
...
public class DataSourceWrapperImpl implements DataSourceWrapper{
	private static final Logger logger = LoggerFactory.getLogger(DataSourceWrapperImpl.class);
	...
	public DataSourceWrapperImpl() {
	}
	public DataSourceWrapperImpl(DataSource dataSource, String closeMethodName, Map<String, String> propertyMap) {
