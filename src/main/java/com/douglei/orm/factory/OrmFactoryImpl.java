...
import com.douglei.orm.factory.dynamic.mapping.DynamicMapping;
...
public class OrmFactoryImpl implements OrmFactory {
	private static final Logger logger = LoggerFactory.getLogger(OrmFactoryImpl.class);
	...
	public OrmFactoryImpl(Configuration configuration, Environment environment) {
