...
import com.douglei.orm.dialect.temp.datatype.handler.classtype.ClassDataTypeHandlerMapping;
import com.douglei.orm.dialect.temp.datatype.handler.dbtype.DBDataTypeHandler;
import com.douglei.orm.dialect.temp.datatype.handler.dbtype.DBDataTypeHandlerMapping;
import com.douglei.orm.dialect.temp.datatype.handler.resultset.columntype.ResultSetColumnDataTypeHandler;
import com.douglei.orm.dialect.temp.datatype.handler.resultset.columntype.ResultSetColumnDataTypeHandlerMapping;
...
public abstract class AbstractDataTypeHandlerMapping{
	...
	public ClassDataTypeHandler getDefaultClassDataTypeHandler() {
		return getDataTypeHandlerByCode(DataType2.STRING.getName());
	}
