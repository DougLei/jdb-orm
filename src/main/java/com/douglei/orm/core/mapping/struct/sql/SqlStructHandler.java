package com.douglei.orm.core.mapping.struct.sql;
 ...
 * @author DougLei
 */
public class SqlStructHandler {
	private static final SerializationHandler serializationHandler = new SerializationHandler();
